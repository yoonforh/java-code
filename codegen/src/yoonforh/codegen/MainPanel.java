/*
 * $Id: MainPanel.java,v 1.1.1.1 2003/05/26 01:53:54 cvsuser Exp $
 *
...
import yoonforh.codegen.actions.CodeGenAction;
 ...
 * ROOT - templates - [subdir (template name)] - template.xml, (template name).jar
 * 
 * @version  $Revision: 1.1.1.1 $<br>
 *           created at 2003-03-24 17:18:27
 * @author   Yoon Kyung Koo
 */

public class MainPanel extends JPanel implements FrameContainer {
    private static Logger logger
	= Logger.getLogger(MainPanel.class.getName());

    private CodeGenerator frame = null;
    private ButtonGroup templateButtonGroup = new ButtonGroup();
    private TemplateManager templateManager = TemplateManager.getInstance();

    public MainPanel(CodeGenerator frame) throws ApplicationException {
	this.frame = frame;
	...
	panel.add(new JButton(new CodeGenAction(this)));
